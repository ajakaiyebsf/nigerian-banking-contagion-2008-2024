...
3. Open `nigerian_banking_contagion.ipynb` in Jupyter, VS Code, or Google Colab and run all cells top to bottom. The notebook reads from `data/raw/` using relative paths.
